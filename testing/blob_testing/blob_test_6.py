...
def tune_params(frames, minDist_tune, param2_tune, eps_tune):
    ...
    average_circles = clean_circles(all_circles)
...
def main():
    ...
    # frames = take_image(1)
    # circles = detect_circles(frames, minDist_tune = 50, param2_tune = 20)
    # print(circles)

    # Capture a specified amount of frames
