...
def detect_ball(view_mode = True):
    ...
    circle_detect_wait_time = 50 # How long you want to wait until a ball is considered to be detected
    ...
    threshold = 8 # Pixel variance allowance between frames of a detected circle, for it to be considered the same circle
    final_circle = []
    ...
    while sum(circle_det_log) < circle_detect_wait_time:
        ...
        # Convert the image to a NumPy array and blur
